...
Client libraries are the APIs that allow users to implement their ROS 2 code.
Client libraries expose users to the core elements of ROS such as nodes, topics, services, etc.
...
Client libraries come in a variety of programming languages so that users can write ROS 2 code in the language that is best-suited for their application.
